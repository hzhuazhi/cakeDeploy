...
var account = {
    //地址
    url:{
        list_url : ctx + '/merchantwithdraw/list.do',
        dataList_url : ctx + "/merchantwithdraw/dataList.do",
        add_url : ctx+ "/merchantwithdraw/add.do",
        update_url : ctx+ "/merchantwithdraw/update.do",
        queryId_url: ctx+ "/merchantwithdraw/getId.do",
        delete_url: ctx+ "/merchantwithdraw/delete.do",
        manyOperation_url: ctx+ "/merchantwithdraw/manyOperation.do"
    },
    //列表显示参数
    list:[
        {"data":"orderNo",},
