    ...
    list:[
        ...
        {"data":"id",
            "fnCreatedCell": function (nTd, sData, oData, iRow, iCol) {
                ...
                // }
                html+= '<a class = "dataTableBtn dataTableDeleteBtn " href="'+ctx+'/merchantchannel/jumpBankUpdate.do?op=1&id='+oData.id+'"> 编辑 </a>';
