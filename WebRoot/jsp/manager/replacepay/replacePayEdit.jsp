        ...
        <form id="addSupplierForm">
            <ul>
                ...
                <li style="border-top: none;">
                    ...
                    <div class="formCtrlDiv">
                        <input type="text" class="formInput" id="companyAds" name="companyAds"	  value="${dl.companyAds}"  maxlength="240" />
                    </div>
                </li>
                <li style="border-top: none;">
                    <div class="formTextDiv">
                ...
                <li style="border-top: none;">
                    ...
                    <div class="formCtrlDiv">
                        <input type="text" class="formInput" id="useBalance" name="useBalance" value="${dl.useBalance}"	maxlength="240" />
                    </div>
                </li>
                <li style="border-top: none;">
                    <div class="formTextDiv">
                    ...
                    <div class="formCtrlDiv">
                        <input type="text" class="formInput" id="inInterfaceAds" name="inInterfaceAds"  value="${dl.inInterfaceAds}"	maxlength="240" />
                    </div>
                </li>
                <li style="border-top: none;">
                    <div class="formTextDiv">
                    ...
                    <div class="formCtrlDiv">
                        <input type="text" class="formInput" id="balanceInterfaceAds" name="balanceInterfaceAds" value="${dl.balanceInterfaceAds}"	maxlength="240" />
                    </div>
                </li>
                <li style="border-top: none;">
                    <div class="formTextDiv">
                    ...
                    <div class="formCtrlDiv">
                        <input type="text" class="formInput" id="businessNum" name="businessNum"	value="${dl.businessNum}" maxlength="240" />
                    </div>
                </li>
                <li style="border-top: none;">
                    <div class="formTextDiv">
                    ...
                    <div class="formCtrlDiv">
                        <input type="text" class="formInput" id="platformBusinessNum" name="platformBusinessNum" value="${dl.platformBusinessNum}"	maxlength="240" />
                    </div>
                </li>
                <li style="border-top: none;">
                    <div class="formTextDiv">
                    ...
                    <div class="formCtrlDiv">
                        <select id="accountAttribute" name="accountAttribute">
                            ...
                            <c:if test="${dl.accountAttribute == 0}">
                                <option value="0" selected="selected">对私</option>
                                <option value="1">对公</option>
                            </c:if>
                            <c:if test="${dl.accountAttribute == 1}">
                                <option value="0" >对私</option>
                                <option value="1"selected="selected">对公</option>
                            </c:if>
                        </select>
                ...
                <li style="border-top: none;">
                    ...
                    <div class="formCtrlDiv">
                        ...
                        <select id="accountType" name="accountType">
                            ...
                            <c:if test="${dl.accountType == 3}">
                                <option value="3" selected="selected">公司账户</option>
                                <option value="4">银行卡</option>
                            </c:if>
                            <c:if test="${dl.accountType == 4}">
                                <option value="3" >公司账户</option>
                                <option value="4"selected="selected">银行卡</option>
                            </c:if>
                        </select>
                ...
                <li style="border-top: none;">
                    ...
                    <div class="formCtrlDiv">
                        <input type="text" class="formInput" id="telephoneNum" name="telephoneNum" value="${dl.telephoneNum}" 	maxlength="240" />
                    </div>
                </li>
                ...
                <li style="border-top: none;">
                    ...
                    <div class="layui-row" >
                        ...
                        <input type="hidden" class="formInput" id="sandKeyPath" name="sandKeyPath" value="${dl.sandKeyPath}"	maxlength="240" />
                    ...
                    <div class="formCtrlDiv">
                        <select id="useStatus" name="useStatus">
                            <c:if test="${dl.useStatus == 1}">
                                <option value="2" selected="selected">正常使用</option>
                                <option value="1">暂停使用</option>
                            </c:if>
                            <c:if test="${dl.useStatus == 2}">
                                <option value="2" >正常使用</option>
                                <option value="1"selected="selected">暂停使用</option>
                            </c:if>
                        </select>
                    </div>
                </li>
