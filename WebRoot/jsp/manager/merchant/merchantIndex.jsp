...
<div class="col_main">
    ...
    <table class="datatable tables">
        ...
        <tr>
            ...
            <th width="150">账号</th>
            <th width="120">所属角色ID</th>
            <th width="100">总额</th>
            <th width="100">保底金额</th>
            <th width="110">手续比例</th>
            <th width="100">余额</th>
            <th width="100">锁定金额</th>
            <th width="100">总收益金额</th>
            <th width="100">可提现金额</th>
            <th width="100">卡商类型</th>
            <th width="120">卡商运营类型</th>
            <th width="120">代付款类型</th>
            <th width="100">今日收益</th>
