    ...
    <div class="formContentDiv">
        <form id="addSupplierForm">
            <ul>
                ...
                <li style="border-top: none;">
                    <div class="formTextDiv">
                        <span class="require" >失败原因</span>
                    </div>
                    <div class="formCtrlDiv">
                        <input type="text" class="formInput" id="checkInfo" name="checkInfo"	maxlength="240" />
                    </div>
                </li>
                ...
                <li>
                    <div class="" style="margin-bottom: 20px; margin-top: 20px;margin-left:200px;">
                        <input type="submit" class="formBtn" value="提交审核" style="background-color: #54D8FE;"/> <span>
    ...
    $(function(){
        ...
        $("#addSupplierForm").validate({
            ...
            submitHandler : function() {
                ...
                $.ajax({
                    url : ctx+ "/merchantwithdraw/update.do",
                    type : 'post',
                    dataType : 'json',
                    data :formData,
                    success : function(data) {
                        if (data.success) {
                            alert("添加成功！！！");
                            window.location.href = ctx + "/merchantwithdraw/list.do";
                        } else {
                            art.alert(data.msg);
                        }
                    },
