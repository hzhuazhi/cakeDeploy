        ...
        <form id="addSupplierForm">
            <ul>
                ...
                <li style="border-top: none;">
                    ...
                    <div class="formCtrlDiv">
                        <input type="text" class="formInput" id="money" name="money" 	value="${dl.money}" maxlength="240" />
                    </div>
                </li>
    ...
    $(function(){
        ...
        $("#addSupplierForm").validate({
            ...
            submitHandler : function() {
                ...
                $.ajax({
                    url : ctx+ "/interestwithdraw/update.do",
                    type : 'post',
                    dataType : 'json',
                    data :formData,
                    success : function(data) {
                        if (data.success) {
                            alert("审核成功！！！");
                            window.location.href = ctx + "/interestwithdraw/list.do";
                        } else {
                            art.alert(data.msg);
                        }
                    },
