    ...
    <div class = "condQueryDiv">
        <form id = "condForm">
            <div class = "condQueryCtrl">
                ...
                <div class="formCtrlDiv" id = "merchantDiv">
                </div>
...
<script type='text/javascript' charset="utf-8" src='${ctxData}js/manager/merchantprofit/merchantprofit.js'></script>
</body>
</html>
