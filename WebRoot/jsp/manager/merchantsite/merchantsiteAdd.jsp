      ...
      function queryBankAll(){
        ...
        common.ajax(url,data,function(data){
            ...
            if(roleType==1){
                ...
                shtml += "<select id='merchantId' name='merchantId' disabled  class='text-input medium-input'>";
                for (var i=0;i<dataList.length>0;i++) {
                    if(id==(dataList[i].id)){
                        shtml +="<option value="+dataList[i].id+">"+dataList[i].alias+"</option>";
                    }
            ...
            submitHandler : function() {
                ...
                $.ajax({
                    ...
                    success : function(data) {
                        if (data.success) {
                            alert("添加成功！！！");
                            window.location.href = ctx + "/merchantsite/list.do";
                        } else {
                            art.alert(data.msg);
                        }
                    },
